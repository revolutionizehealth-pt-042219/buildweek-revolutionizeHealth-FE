...
// Create rows for TABLE HEAD 
    const rows = [
        { id: 'procedure_name',         label: 'Procedure Name',        numeric: false, disablePadding: true   },
        { id: 'doctor_name',            label: 'doctor',                numeric: false, disablePadding: true   },
        { id: 'hospital_name',          label: 'hospital_name',         numeric: false, disablePadding: true   },
        // { id: 'city',                   label: 'City',                  numeric: false, disablePadding: true,  },
        // { id: 'state',                  label: 'State',                 numeric: false, disablePadding: true,  },

        { id: 'procedure_cost',         label: 'Procedure Cost',        numeric: true,  disablePadding: true,  },
        { id: 'out_of_pocket',          label: 'Out of Pocket',         numeric: true,  disablePadding: true,  },
        { id: 'insurance_adjustment',   label: 'Insurance Adjustment',  numeric: true,  disablePadding: true,  },
        { id: 'insurance_payment',      label: 'Insurance Payment',     numeric: true,  disablePadding: true,  },
    ];
...
// -- ** -- ** -- ** -- ** -- ** -- ** -- //
    ...
    procedure_chipFilter = (currentPropsProcedures, item) => {
        let columnToFilter = "procedure_name";
            ...
            console.log('TABLE action creator: ',currentPropsProcedures, columnToFilter, item)
            
        // ACTION CREATOR 
            this.props.filter_by_procedure(currentPropsProcedures, columnToFilter, item)
    }
    // -2- //
                        ...
                        >
                            <TableCell component="th" align='center' scope="row" padding="none">
                                <Chip
                                    ...
                                    variant="outlined"
                                    clickable={true}
                                    onClick={() => this.procedure_chipFilter(this.props.procedures, n.procedure_name)}
                                />
                            </TableCell>
                            <TableCell align="center">
                                <Chip 
                                    ...
                                    variant="outlined"
                                    clickable={true}
                                    onClick={() => this.doctor_chipFilter(this.props.procedures, n.doctor_name)}
                                />
                            </TableCell>
                            <TableCell align="center">
                                <Chip 
                                    ...
                                    variant="outlined"
                                    clickable={true}
                                    onClick={() => this.hospital_chipFilter(this.props.procedures, n.hospital_name)}
                                />
                            </TableCell>
                            {/* <TableCell align="center">
                                <Chip 
                            ...
                            <TableCell align="center">{n.insurance_payment}</TableCell>
                            <TableCell align="center">{n.insurance_adjustment}</TableCell>
                        </TableRow>
                    );
                    })}
                {emptyRows > 0 && (
