...
// ACTION CREATOR
// -1- //
export const filter_by_procedure = (
  ...
  let payload_Array = currentPropsProcedures.filter(
    procedure => procedure[columnToFilter] === item
  );
...
// -3- //
export const filter_by_hospital = (
  currentPropsProcedures,
  columnToFilter,
  item
) => {
